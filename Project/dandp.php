...
if($_GET['sort'] == 1){
  $sql="SElect * from products where id between 77 and 94 order by price";
}else if($_GET['sort']==2){
  $sql="SElect * from products where id between 77 and 94 order by id";
}else{
  $sql="SElect * from products where id between 77 and 94 order by quantity";
}
